...
export const ROMANCE_DATA: RomanceComponent[] = [
  ...
  // ==========================
  { def: 'New', type: 'adj_quality', tags: ['pre'], es: 'Nuevo', it: 'Nuovo', fr: ['Nouveau', 'Nouvelle'], pt: 'Novo', ro: ['Nou', 'Nouă'] },
  { def: 'Old', type: 'adj_quality', tags: ['pre'], es: 'Viejo', it: 'Vecchio', fr: ['Vieux', 'Vieille'], pt: 'Velho', ro: ['Vechi', 'Veche'] },
  { def: 'Good', type: 'adj_quality', tags: ['pre'], es: 'Buen', it: 'Buon', fr: ['Bon', 'Bonne'], pt: 'Bom', ro: 'Bun' },
  { def: 'Bad', type: 'adj_quality', tags: ['pre'], es: 'Mal', it: 'Mal', fr: 'Mauvais', pt: 'Mau', ro: ['Rău', 'Rea'] },
  { def: 'Beautiful', type: 'adj_quality', tags: ['pre'], es: 'Bello', it: 'Bello', fr: ['Beau', 'Belle'], pt: 'Belo', ro: ['Frumos', 'Frumoasă'] },
  ...
  { def: 'Brave', type: 'adj_quality', es: 'Valiente', it: 'Coraggioso', fr: ['Brave', 'Brave'], pt: 'Valente', ro: ['Curajos', 'Curajoasă'] },
  ...
  { def: 'Low', type: 'adj_geo', tags: ['pre'], es: 'Bajo', it: 'Basso', fr: ['Bas', 'Basse'], pt: 'Baixo', ro: ['Jos', 'Jos'] },
  { def: 'Long', type: 'adj_geo', es: 'Largo', it: 'Lungo', fr: ['Long', 'Longue'], pt: 'Longo', ro: 'Lung' },
  { def: 'North', type: 'adj_geo', es: 'Norte', it: 'Nord', fr: ['Nord', 'Nord'], pt: 'Norte', ro: ['Nord', 'Nord'] },
  { def: 'South', type: 'adj_geo', es: 'Sur', it: 'Sud', fr: ['Sud', 'Sud'], pt: 'Sul', ro: ['Sud', 'Sud'] },
  { def: 'East', type: 'adj_geo', es: 'Este', it: 'Est', fr: ['Est', 'Est'], pt: 'Leste', ro: ['Est', 'Est'] },
  { def: 'West', type: 'adj_geo', es: 'Oeste', it: 'Ovest', fr: ['Ouest', 'Ouest'], pt: 'Oeste', ro: ['Vest', 'Vest'] },
  ...
  { def: 'Dry', type: 'adj_geo', es: 'Seco', it: 'Secco', fr: ['Sec', 'Sèche'], pt: 'Seco', ro: ['Sec', 'Seacă'] },
  ...
  { def: 'Upper', type: 'adj_geo', es: 'Alto', it: 'Sopra', fr: 'Supérieur', pt: 'Alto', ro: ['Sus', 'Sus'] },
  { def: 'Lower', type: 'adj_geo', es: 'Bajo', it: 'Sotto', fr: ['Bas', 'Basse'], pt: 'Baixo', ro: ['Jos', 'Jos'] },
  ...
  { def: 'Black', type: 'adj_color', es: 'Negro', it: 'Nero', fr: 'Noir', pt: 'Preto', ro: ['Negru', 'Neagră'] },
  { def: 'Red', type: 'adj_color', es: 'Rojo', it: 'Rosso', fr: ['Rouge', 'Rouge'], pt: 'Vermelho', ro: ['Roșu', 'Roșie'] },
  ...
  { def: 'Grey', type: 'adj_color', es: 'Gris', it: 'Grigio', fr: 'Gris', pt: 'Cinza', ro: ['Gri', 'Gri'] },
  ...
  { def: 'Sun', type: 'abstract', tags: ['no_saint'], es: ['Sol', 'm'], it: ['Sole', 'm'], fr: ['Soleil', 'm'], pt: ['Sol', 'm'], ro: ['Soare', 'm'] },
  { def: 'Moon', type: 'abstract', tags: ['no_saint'], es: ['Luna', 'f'], it: ['Luna', 'f'], fr: ['Lune', 'f'], pt: ['Lua', 'f'], ro: ['Lună', 'f'] },
  { def: 'Star', type: 'abstract', tags: ['no_saint'], es: ['Estrella', 'f'], it: ['Stella', 'f'], fr: ['Étoile', 'f'], pt: ['Estrela', 'f'], ro: ['Stea', 'f'] },
  { def: 'Wind', type: 'abstract', tags: ['no_saint'], es: ['Viento', 'm'], it: ['Vento', 'm'], fr: ['Vent', 'm'], pt: ['Vento', 'm'], ro: ['Vânt', 'n'] },
  { def: 'Rain', type: 'abstract', tags: ['no_saint'], es: ['Lluvia', 'f'], it: ['Pioggia', 'f'], fr: ['Pluie', 'f'], pt: ['Chuva', 'f'], ro: ['Ploaie', 'f'] },
  { def: 'Snow', type: 'abstract', tags: ['no_saint'], es: ['Nieve', 'f'], it: ['Neve', 'f'], fr: ['Neige', 'f'], pt: ['Neve', 'f'], ro: ['Zăpadă', 'f'] },
  { def: 'Ice', type: 'abstract', tags: ['no_saint'], es: ['Hielo', 'm'], it: ['Ghiaccio', 'm'], fr: ['Glace', 'f'], pt: ['Gelo', 'm'], ro: ['Gheață', 'f'] },
  { def: 'Fog', type: 'abstract', tags: ['no_saint'], es: ['Niebla', 'f'], it: ['Nebbia', 'f'], fr: ['Brouillard', 'm'], pt: ['Nevoeiro', 'm'], ro: ['Ceață', 'f'] },
  { def: 'Mist', type: 'abstract', tags: ['no_saint'], es: ['Neblina', 'f'], it: ['Foschia', 'f'], fr: ['Brume', 'f'], pt: ['Bruma', 'f'], ro: ['Negură', 'f'] },
  { def: 'Storm', type: 'abstract', tags: ['no_saint'], es: ['Tormenta', 'f'], it: ['Tempesta', 'f'], fr: ['Tempête', 'f'], pt: ['Tempestade', 'f'], ro: ['Furtună', 'f'] },
  { def: 'Thunder', type: 'abstract', tags: ['no_saint'], es: ['Trueno', 'm'], it: ['Tuono', 'm'], fr: ['Tonnerre', 'm'], pt: ['Trovão', 'm'], ro: ['Tunet', 'n'] },
  { def: 'Lightning', type: 'abstract', tags: ['no_saint'], es: ['Rayo', 'm'], it: ['Fulmine', 'm'], fr: ['Éclair', 'm'], pt: ['Relâmpago', 'm'], ro: ['Fulger', 'n'] },
  { def: 'Winter', type: 'abstract', tags: ['no_saint'], es: ['Invierno', 'm'], it: ['Inverno', 'm'], fr: ['Hiver', 'm'], pt: ['Inverno', 'm'], ro: ['Iarnă', 'f'] },
  { def: 'Summer', type: 'abstract', tags: ['no_saint'], es: ['Verano', 'm'], it: ['Estate', 'm'], fr: ['Été', 'm'], pt: ['Verão', 'm'], ro: ['Vară', 'f'] },
  { def: 'SpringSeason', type: 'abstract', tags: ['no_saint'], es: ['Primavera', 'f'], it: ['Primavera', 'f'], fr: ['Printemps', 'm'], pt: ['Primavera', 'f'], ro: ['Primăvară', 'f'] },
  { def: 'Autumn', type: 'abstract', tags: ['no_saint'], es: ['Otoño', 'm'], it: ['Autunno', 'm'], fr: ['Automne', 'm'], pt: ['Outono', 'm'], ro: ['Toamnă', 'f'] },
  { def: 'Morning', type: 'abstract', tags: ['no_saint'], es: ['Mañana', 'f'], it: ['Mattina', 'f'], fr: ['Matin', 'm'], pt: ['Manhã', 'f'], ro: ['Dimineață', 'f'] },
  { def: 'Night', type: 'abstract', tags: ['no_saint'], es: ['Noche', 'f'], it: ['Notte', 'f'], fr: ['Nuit', 'f'], pt: ['Noite', 'f'], ro: ['Noapte', 'f'] },
  { def: 'Shadow', type: 'abstract', tags: ['no_saint'], es: ['Sombra', 'f'], it: ['Ombra', 'f'], fr: ['Ombre', 'f'], pt: ['Sombra', 'f'], ro: ['Umbră', 'f'] },
  ...
  { def: 'Gold', type: 'abstract', tags: ['no_saint'], es: ['Oro', 'm'], it: ['Oro', 'm'], fr: ['Or', 'm'], pt: ['Ouro', 'm'], ro: ['Aur', 'n'] },
  { def: 'Silver', type: 'abstract', tags: ['no_saint'], es: ['Plata', 'f'], it: ['Argento', 'm'], fr: ['Argent', 'm'], pt: ['Prata', 'f'], ro: ['Argint', 'n'] },
  { def: 'Iron', type: 'abstract', tags: ['no_saint'], es: ['Hierro', 'm'], it: ['Ferro', 'm'], fr: ['Fer', 'm'], pt: ['Ferro', 'm'], ro: ['Fier', 'n'] },
  { def: 'Salt', type: 'abstract', tags: ['no_saint'], es: ['Sal', 'f'], it: ['Sale', 'm'], fr: ['Sel', 'm'], pt: ['Sal', 'm'], ro: ['Sare', 'f'] },
  { def: 'Copper', type: 'abstract', tags: ['no_saint'], es: ['Cobre', 'm'], it: ['Rame', 'm'], fr: ['Cuivre', 'm'], pt: ['Cobre', 'm'], ro: ['Cupru', 'n'] },
  { def: 'Clay', type: 'abstract', tags: ['no_saint'], es: ['Barro', 'm'], it: ['Argilla', 'f'], fr: ['Argile', 'f'], pt: ['Barro', 'm'], ro: ['Lut', 'n'] },
  { def: 'Marble', type: 'abstract', tags: ['no_saint'], es: ['Mármol', 'm'], it: ['Marmo', 'm'], fr: ['Marbre', 'm'], pt: ['Mármore', 'm'], ro: ['Marmură', 'f'] },
  { def: 'Glass', type: 'abstract', tags: ['no_saint'], es: ['Cristal', 'm'], it: ['Vetro', 'm'], fr: ['Verre', 'm'], pt: ['Vidro', 'm'], ro: ['Sticlă', 'f'] },
  { def: 'Honey', type: 'abstract', tags: ['no_saint'], es: ['Miel', 'f'], it: ['Miele', 'm'], fr: ['Miel', 'm'], pt: ['Mel', 'm'], ro: ['Miere', 'f'] },
  { def: 'Wine', type: 'abstract', tags: ['no_saint'], es: ['Vino', 'm'], it: ['Vino', 'm'], fr: ['Vin', 'm'], pt: ['Vinho', 'm'], ro: ['Vin', 'n'] },
  { def: 'Bread', type: 'abstract', tags: ['no_saint'], es: ['Pan', 'm'], it: ['Pane', 'm'], fr: ['Pain', 'm'], pt: ['Pão', 'm'], ro: ['Pâine', 'f'] },
