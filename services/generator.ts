...
import { generateFrenchPlace, getFrenchCapacity } from "./engines/romance/french";
import { generateSpanishPlace, getSpanishCapacity } from "./engines/romance/spanish";
import { generateItalianPlace, getItalianCapacity } from "./engines/romance/italian";
...
import { generateSwedishPlace, getSwedishCapacity } from "./engines/germanic/swedish";
import { generateDanishPlace, getDanishCapacity } from "./engines/germanic/danish";
import { generateDutchPlace, getDutchCapacity } from "./engines/germanic/dutch";
import { generatePolishPlace, getPolishCapacity } from "./engines/slavic/polish";
import { generateIrishPlace, getIrishCapacity } from "./engines/irish";
import { generateCzechPlace, getCzechCapacity } from "./engines/slavic/czech";
import { generateRussianPlace, getRussianCapacity } from "./engines/slavic/russian";
import { generateUkrainianPlace, getUkrainianCapacity } from "./engines/slavic/ukrainian";
import { generateSlovakPlace, getSlovakCapacity } from "./engines/slavic/slovak";
import { generateBulgarianPlace, getBulgarianCapacity } from "./engines/slavic/bulgarian";
import { generatePortuguesePlace, getPortugueseCapacity } from "./engines/romance/portuguese";
import { generateRomanianPlace, getRomanianCapacity } from "./engines/romance/romanian";
