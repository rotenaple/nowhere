...
export const EN_ROOTS_ANGLO = [
  ...
  'Apple', 'Pear', 'Plum', 'Cherry', 'Bean', 'Barley', 'Wheat', 'Rye',
  'Hay', 'Straw', 'Reed', 'Flax', 'Wool', 'Hide', 'Leather', 'Cloth',
  'Market', 'Trade', 'Port', 'Haven', 'Dock', 'Ship', 'Boat', 'Sail',
  'King', 'Queen', 'Prince', 'Lord', 'Lady', 'Knight', 'Abbot', 'Monk',
  'Bishop', 'Priest', 'Nun', 'Saint', 'Holy', 'Cross', 'Church', 'Kirk',
  'Wall', 'Tower', 'Castle', 'Hall', 'House', 'Cot', 'Barn', 'Mill',
  'Mine', 'Forge', 'Smith', 'Baker', 'Cook', 'Fisher', 'Hunter', 'Shepherd',
  'Gold', 'Silver', 'Copper', 'Lead', 'Tin', 'Iron', 'Steel', 'Brass',
  'Glass', 'Cloth', 'Silk', 'Linen', 'Leather', 'Felt', 'Fur', 'Hair',
  'Elm', 'Ash', 'Oak', 'Beech', 'Birch', 'Lime', 'Maple', 'Pine',
  'Yew', 'Willow', 'Alder', 'Hazel', 'Holly', 'Ivy', 'Misty', 'Cloudy',
  'Rainy', 'Sunny', 'Windy', 'Stormy', 'Frosty', 'Icy', 'Snowy',
  'Muddy', 'Sandy', 'Rocky', 'Stony', 'Grassy', 'Leafy', 'Thorny',
  'Flowery', 'Weedy', 'Mossy', 'Ferny', 'Rushy', 'Sedgy', 'Reed',
  'Deer', 'Stag', 'Buck', 'Doe', 'Fawn', 'Boar', 'Sow', 'Pig',
  'Hound', 'Dog', 'Cat', 'Rat', 'Mouse', 'Mole', 'Hare', 'Rabbit',
  'Badger', 'Otter', 'Beaver', 'Squirrel', 'Fox', 'Wolf', 'Bear',
  'Eagle', 'Hawk', 'Falcon', 'Owl', 'Crow', 'Raven', 'Rook', 'Starling',
  'Thrush', 'Blackbird', 'Sparrow', 'Robin', 'Wren', 'Lark', 'Finch',
  'Swan', 'Goose', 'Duck', 'Heron', 'Crane', 'Stork', 'Plover',
  'Salmon', 'Trout', 'Eel', 'Pike', 'Perch', 'Carp', 'Tench'
];
...
export const EN_SUFFIXES_ANGLO = [
  ...
  'moor', 'moss', 'mount', 'park', 'peak', 'pool', 'port', 'quarry',
  'ridge', 'rise', 'road', 'row', 'run', 'scar', 'seat', 'shaw',
  'side', 'slack', 'slade', 'snook', 'spring', 'stack', 'stead', 'ster',
  'stow', 'strath', 'stream', 'street', 'syke', 'tarn', 'thorp', 'thwaite',
  'toft', 'ton', 'top', 'tor', 'town', 'tree', 'vale', 'valley',
  'view', 'vill', 'ville', 'wath', 'way', 'weald', 'well', 'wick',
  'wold', 'wood', 'worth', 'wyke', 'yard', 'yett', 'bury', 'caster',
  'chester', 'cester', 'minster', 'mouth', 'water', 'over', 'under'
];
