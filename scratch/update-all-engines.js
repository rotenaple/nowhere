...
updateFile('vietnamese.ts', [
  ...
  [
    `    word = \`\${head.word} \dots \${mid.word} \dots \${tail.word}\`;
    ascii = \`\${head.ascii} \dots \${mid.ascii} \dots \${tail.ascii}\`;
  }`.replace(/\dots/g, '\\$1'), // Wait, let's look at what the original was.
  // Original: word = `${head.word} ${mid.word} ${tail.word}`; ascii = `${head.ascii} ${mid.ascii} ${tail.ascii}`;
...
console.log("All updates loaded successfully");
